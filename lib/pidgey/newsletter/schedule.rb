  ...
  module Newsletter
    module Schedule
      ...
      def add_schedule_newsletter(name, at = nil, after = nil)
        ...
        self.post("/newsletter/schedule/add.json", { body: q })
      end
      ...
      def get_schedule_newsletter(name)
        self.post("/newsletter/schedule/get.json", { body: { name: name } })
      end
      ...
      def delete_schedule_newsletter(name)
        self.post("/newsletter/schedule/delete.json", { body: { name: name } })
      end
    end
  end
end