  ...
  module Newsletter
    module Recipient
      ...
      def add_recipients_newsletter(list, name)
        self.post("/newsletter/recipients/add.json", { query: { list: list, name: name } })
      end
      ...
      def get_recipients_newsletter(name)
        self.post("/newsletter/recipients/get.json", { query: { name: name } })
      end
      ...
      def delete_recipients_newsletter(list, name)
        self.post("/newsletter/schedule/delete.json", { query: { list: list, name: name } })
      end
    end
  end
end
