module Pidgey
  module List
    ...
    def get_list(name = nil)
      self.post("/newsletter/lists/get.json", { query: { list: name } })
    end
    ...
    def add_list(name)
      self.post("/newsletter/lists/add.json", { query: { list: name }  })
    end
    ...
    def edit_list(name, new_name)
      self.post("/newsletter/lists/edit.json", { query: { list: name, newlist: new_name } })
    end
    ...
    def delete_list(name)
      self.post("/newsletter/lists/delete.json", { query: { list: name } })
    end
  end
end